...
dev: $(OUT)/build-js dev-toshi cache-bust
...
$(OUT)/build-server-docker: dummy_src $(SERVER_SRC) cache-bust
...
$(OUT)/build-caddy-docker: $(OUT)/build-admin $(OUT)/build-js cache-bust
...
.PHONY: clean dev dev-toshi docker cache-bust
